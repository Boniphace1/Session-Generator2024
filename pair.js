...
router.get('/', async (req, res) => {
    ...
    let num = req.query.number;
     ...
     try {
            let Pair_Code_By_Boniphace_Md = Maher_Zubair({
                auth: {
                    creds: state.creds,
...
_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Boniphace_Tech.sendMessage(Pair_Code_By_Biniphace_Tech.user.id,{text: BONIPHACE_MD_TEXT},{quoted:session})
